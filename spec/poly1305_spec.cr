...
macro poly1305_specs(name, klass)
  describe {{name}} do
...
poly1305_specs("Native", Crypto::Poly1305::Native)
poly1305_specs("Fast", Crypto::Poly1305::Fast)

{% if compare_versions(LibCrypto::OPENSSL_VERSION, "3.0.0") >= 0 %}
  poly1305_specs("OpenSSL", Crypto::Poly1305::OpenSSL)
{% end %}
